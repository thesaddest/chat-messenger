...
import { addMessage, deleteMessage, getMessages, IDeleteMessage, IMessage } from "../../../entities/message";
...
export const useSocket = () => {
    ...
    useEffect(() => {
        ...
        socket.on(SOCKET_EVENTS.DELETE_MESSAGES, (messageId: IDeleteMessage) => {
